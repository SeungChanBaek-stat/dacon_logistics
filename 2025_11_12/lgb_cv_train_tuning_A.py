...
# best num_leaves = 32, min_data_in_leaf = 200
# [num_leaves=32, min_data_in_leaf=100] mean score: 0.175305, std score: 0.004771
# [num_leaves=32, min_data_in_leaf=150] mean score: 0.174910, std score: 0.005011
# [num_leaves=32, min_data_in_leaf=200] mean score: 0.174815, std score: 0.004949
# [num_leaves=32, min_data_in_leaf=250] mean score: 0.174987, std score: 0.005146
# [num_leaves=48, min_data_in_leaf=100] mean score: 0.174789, std score: 0.005024
# [num_leaves=48, min_data_in_leaf=150] mean score: 0.174816, std score: 0.005171
# [num_leaves=48, min_data_in_leaf=200] mean score: 0.174712, std score: 0.005080
# [num_leaves=48, min_data_in_leaf=250] mean score: 0.174675, std score: 0.004910

# [num_leaves=96, min_data_in_leaf=200] mean score: 0.175066, std score: 0.005069
# [num_leaves=96, min_data_in_leaf=250] mean score: 0.174947, std score: 0.004818
...
num_boost_round_list = [300, 400, 500, 600, 700, 800]
...
# for leaf, min_data in product(num_leaves_list, min_data_in_leaf_list):
for boost_round in num_boost_round_list:
    ...
    for fold, (train_idx, valid_idx) in enumerate(skf.split(X_real, y_real), start=1):
        ...
        model = lgb.train(
            ...
            # callbacks = [lgb.log_evaluation(200), lgb.early_stopping(stopping_rounds=200)]
...
# print(f"\n✅ Best params → boost_round={int(best_row.boost_round)}, min_data_in_leaf={int(best_row.min_data_in_leaf)} "
