...
def main():
    ...
    TEST_DIR  = os.path.join(parent_path, "data")
    MODEL_DIR = os.path.join(curr_path, "model")
    OUT_DIR   = os.path.join(curr_path, "output")
    # TEST_DIR  = parent_path + "\data"              # test.csv, A.csv, B.csv, sample_submission.csv 위치
    # MODEL_DIR = curr_path + "\model"             # lgbm_A.pkl, lgbm_B.pkl 위치
    # OUT_DIR   = curr_path + "\output"
