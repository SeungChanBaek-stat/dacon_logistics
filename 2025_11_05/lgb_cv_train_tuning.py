...
for l1, l2 in product(lambda_l1_list, lambda_l2_list):
    ...
    results.append((l1, l2, mean_score, std_score))
    print(f"[lambda_l1={l1}, lambda_l2={l2}] mean score: {mean_score:.6f}, std score: {std_score:.6f}")


# === 모든 실험 끝난 후 ===
results_df = pd.DataFrame(results, columns=["lambda_l1", "lambda_l2", "mean_score", "std_score"])
...
print(f"\n✅ Best params → lambda_l1={int(best_row.lambda_l1)}, lambda_l2={int(best_row.lambda_l2)} "
